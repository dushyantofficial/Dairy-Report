                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-4 col-xl-6">
                            ...
                            <div class="card info-card customers-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title"><a href="{{route('user.index')}}">@lang('langs.users')</a>
                                    </h5>
                            ...
                            <div class="card info-card customers-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title"><a
                                            href="{{route('customer.index')}}">@lang('langs.customer')</a></h5>
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card sales-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title"><a
                                            href="{{route('item_sales.index')}}">@lang('langs.item_sales')</a></h5>
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card revenue-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title"><a
                                            href="{{route('item_purchase.index')}}">@lang('langs.item_purchase')</a>
                                    </h5>
