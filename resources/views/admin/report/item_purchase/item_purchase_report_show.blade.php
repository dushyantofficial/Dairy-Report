                        ...
                        <div class="modal-body">
                            <form id="myform" action="{{route('item_purchase_report_export')}}" method="get">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <input type="checkbox" id="item_name_id" name="field[item_name_id]"
                                               value="item_name_id">
                                        <label for="customer_name"> @lang('langs.item_name') </label><br>
                                        <input type="checkbox" id="Sales_Rates" name="field[Sales_Rates]"
                                               value="Sales_Rates">
                                        <label for="Sales_Rates"> @lang('langs.Sales_Rates')</label><br>

                                    </div>
                                    <div class="col-md-2">
                                        <input type="checkbox" id="item_quantity" name="field[item_quantity]"
                                               value="item_sales_id">
                                    ...
                                    <div class="col-md-2">
                                        <input type="checkbox" id="Purchase_Rate" name="field[Purchase_Rate]"
                                               value="Purchase_Rate">
